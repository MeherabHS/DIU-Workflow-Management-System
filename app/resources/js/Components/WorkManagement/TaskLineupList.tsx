...
export default function TaskLineupList({ tasks }: { tasks: TaskItem[] }) {
    if (!tasks.length) {
        return (
            <div className="flex h-32 items-center justify-center text-sm text-gray-400">No upcoming tasks.</div>
        );
    }
